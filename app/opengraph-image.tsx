...
export default function OpenGraphImage(){return new ImageResponse(<div style={{display:'flex',position:'relative',width:'100%',height:'100%',overflow:'hidden',alignItems:'flex-end',padding:'68px',background:'#1c0e08',color:'#f5e6d2',fontFamily:'sans-serif'}}>
  <div style={{display:'flex',position:'absolute',inset:0,opacity:.18,backgroundImage:'linear-gradient(#c9804a 1px, transparent 1px), linear-gradient(90deg,#c9804a 1px,transparent 1px)',backgroundSize:'72px 72px'}}/>
