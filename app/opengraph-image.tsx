...
export default function OpenGraphImage(){return new ImageResponse(<div style={{display:'flex',position:'relative',width:'100%',height:'100%',overflow:'hidden',alignItems:'flex-end',padding:'68px',background:'#181714',color:'#e7dfd1',fontFamily:'sans-serif'}}>
  <div style={{display:'flex',position:'absolute',inset:0,opacity:.14,backgroundImage:'linear-gradient(#e7dfd1 1px, transparent 1px), linear-gradient(90deg,#e7dfd1 1px,transparent 1px)',backgroundSize:'72px 72px'}}/>
