...
export function AboutPage(){
  ...
  return <div ref={root} className="editorial-page about-page mx-auto min-h-svh w-[calc(100%_-_36px)] max-w-[1020px] pt-4 pb-6 text-center md:w-[min(1180px,91vw)] md:pt-[clamp(78px,9vh,108px)] md:pb-[120px] md:text-left">
