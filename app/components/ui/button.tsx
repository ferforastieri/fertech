...
const base='group flex min-h-10.5 w-max cursor-pointer items-center justify-between gap-7 border border-paper bg-transparent px-4 text-label font-bold tracking-[.1em] text-paper uppercase transition-[background,color] duration-250 hover:bg-paper hover:text-ink focus-visible:bg-paper focus-visible:text-ink focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-55'
