...
export function GlobalProfile(){
  ...
  return <>
    ...
    <footer id="contato" className="global-profile relative z-10 mx-auto mt-8 w-[calc(100%_-_36px)] border-t border-[color-mix(in_srgb,var(--paper)_28%,transparent)] px-1 pt-6 pb-[calc(72px+env(safe-area-inset-bottom))] text-paper md:mt-12 md:w-[calc(100%_-_9vw)] md:px-0 md:py-5">
