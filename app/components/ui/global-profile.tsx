...
export function GlobalProfile(){
  ...
  return <>
    ...
    <footer id="contato" className={`global-profile relative z-10 mx-auto mt-0 w-[calc(100%_-_36px)] px-1 pt-6 text-paper transition-[padding-bottom] duration-340 ease-[cubic-bezier(.22,1,.36,1)] md:w-[calc(100%_-_9vw)] md:border-t md:px-0 md:pt-5 ${navPosition==='bottom'?'pb-[calc(88px+env(safe-area-inset-bottom))] md:pb-[88px]':'pb-[calc(24px+env(safe-area-inset-bottom))] md:pb-5'}`}>
