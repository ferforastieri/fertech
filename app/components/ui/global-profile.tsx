...
export function GlobalProfile(){
  ...
  return <aside className="global-profile scene-item relative z-30 mx-auto mt-6 mb-[calc(32px+env(safe-area-inset-bottom))] block w-[min(calc(100%_-_48px),300px)] border-t border-[color-mix(in_srgb,var(--paper)_32%,transparent)] pt-6 text-center text-[color-mix(in_srgb,var(--paper)_92%,transparent)] md:fixed md:top-[26px] md:right-[4.5vw] md:m-0 md:w-[min(21vw,250px)] md:border-0 md:pt-0 md:text-right md:max-[1100px]:w-[210px]">
