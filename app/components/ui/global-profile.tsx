...
export function GlobalProfile(){
  ...
  return <>
    ...
    <footer id="contato" className={`global-profile relative z-10 mx-auto mt-8 w-[calc(100%_-_36px)] border-t border-[color-mix(in_srgb,var(--paper)_28%,transparent)] px-1 pt-6 text-paper md:mt-12 md:w-[calc(100%_-_9vw)] md:px-0 md:pt-5 ${navPosition==='bottom'?'mb-[calc(76px+env(safe-area-inset-bottom))] pb-[calc(24px+env(safe-area-inset-bottom))] md:mb-20 md:pb-5':'mb-0 pb-[calc(72px+env(safe-area-inset-bottom))] md:pb-5'}`}>
