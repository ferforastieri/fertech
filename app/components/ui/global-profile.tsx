...
export function GlobalProfile(){
  ...
  return <aside className="global-profile scene-item">
    ...
    <a className="global-profile__contact" href="https://linkedin.com/in/fernando-forastieri" target="_blank" rel="noreferrer"><TypedText text={profile('cta')}/><span aria-hidden="true">↗</span></a>
  </aside>
}
