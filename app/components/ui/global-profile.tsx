...
export function GlobalProfile(){
  ...
  return <footer id="contato" className="global-profile relative z-10 mx-auto mt-5 w-[calc(100%_-_36px)] border-t border-[color-mix(in_srgb,var(--paper)_28%,transparent)] px-1 pt-4 pb-[calc(72px+env(safe-area-inset-bottom))] text-paper md:mt-0 md:min-h-[210px] md:w-[calc(100%_-_9vw)] md:px-0 md:pt-5 md:pb-5">
    <div className="grid grid-cols-2 gap-x-5 gap-y-4 md:absolute md:inset-x-0 md:top-5 md:grid-cols-[1fr_auto_1fr] md:items-start">
    ...
    <div className="mx-auto flex max-w-[860px] flex-wrap items-center justify-center gap-x-6 gap-y-3 pt-7 text-center md:min-h-[158px] md:flex-nowrap md:gap-x-7 md:pt-7">
      <p className="global-profile__signature m-0 origin-center -rotate-2 font-display text-[clamp(38px,10vw,50px)] leading-[.82] italic md:text-[clamp(42px,4vw,58px)]"><TypedText text={profile('signature')}/></p>
    ...
    <div className="mt-5 grid gap-3 border-t border-[color-mix(in_srgb,var(--paper)_18%,transparent)] pt-4 md:absolute md:inset-x-0 md:bottom-5 md:mt-0 md:grid-cols-[1fr_auto_1fr] md:items-end md:border-0 md:pt-0">
