...
export function ResumePage(){
  ...
  return <main ref={root} className="editorial-page resume-page mx-auto min-h-svh w-[calc(100%_-_36px)] max-w-[1080px] pt-4 pb-6 text-center md:w-[min(1180px,91vw)] md:pt-[clamp(78px,9vh,108px)] md:pb-[120px] md:text-left" data-resume-document>
    ...
    <section className="resume-summary resume-reveal grid grid-cols-1 justify-items-center gap-[30px] py-10 opacity-0 motion-reduce:opacity-100 motion-reduce:transform-none md:grid-cols-[minmax(180px,.4fr)_1fr] md:justify-items-stretch md:gap-14 md:py-16"><p className="m-0 text-caption font-[750] tracking-[.18em] uppercase opacity-50">{t('summaryEyebrow')}</p><h2 className="m-0 font-display text-[clamp(24px,7.5vw,32px)] leading-[1.13] font-normal tracking-[-.02em] md:text-[clamp(27px,3.5vw,43px)]">{t('summary')}</h2></section>
