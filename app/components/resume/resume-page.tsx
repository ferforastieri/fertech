...
export function ResumePage(){
  ...
  return <main ref={root} className="editorial-page resume-page mx-auto min-h-svh w-[calc(100%_-_36px)] max-w-[1080px] pt-4 text-center md:w-[min(1180px,91vw)] md:pt-[clamp(78px,9vh,108px)] md:text-left" data-resume-document>
